...
Timeline is a web application which aims to organizer photos similar to how 
Google Photos or Amazon Photos does. Instead of Google or Amazon Photos it is no running in the cloud
...
When using docker the photo path is mounted read-only. If this it running on a Dynology or QNAP Device the preview generated by DSM or QTS are ignored.
...
* In order to ease up the face classifcation it clusters similar faces for easy naming
...
* When viewing an Photo in fullscreen you will see of of the detected information (Identified and non identified faces, things 
